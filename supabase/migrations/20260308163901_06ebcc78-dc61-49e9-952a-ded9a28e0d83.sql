...
CREATE OR REPLACE FUNCTION public.create_group_with_admin(
  ...
  group_is_open_goal boolean DEFAULT false,
  group_competition_end_date timestamptz DEFAULT NULL
)
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  INSERT INTO public.groups (name, description, goal_amount, image_url, created_by, invite_code, group_type, category, is_open_goal, competition_end_date)
  VALUES (group_name, group_description, group_goal_amount, group_image_url, v_user_id, v_invite_code, v_group_type, v_category, COALESCE(group_is_open_goal, false), group_competition_end_date)
