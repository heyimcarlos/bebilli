  ...
  public: {
    Tables: {
      ...
      bot_group_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "bot_group_links_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
      ...
      goal_completion_proofs: {
        ...
        Relationships: [
          {
            foreignKeyName: "goal_completion_proofs_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
            referencedRelation: "groups"
            referencedColumns: ["id"]
      ...
      goal_proof_votes: {
        ...
        Relationships: [
          {
            foreignKeyName: "goal_proof_votes_proof_id_fkey"
            columns: ["proof_id"]
            isOneToOne: false
            referencedRelation: "goal_completion_proofs"
            referencedColumns: ["id"]
          },
        ]
      }
