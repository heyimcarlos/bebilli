...
interface AuthContextType {
  ...
  createGroup: (name: string, goalAmount: number, imageUrl?: string, description?: string, groupType?: 'individual' | 'shared', category?: string, isOpenGoal?: boolean, competitionEndDate?: string) => Promise<any>;
